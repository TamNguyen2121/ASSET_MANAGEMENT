<div class="mt-1">
    <nav class="nav nav-pills flex-column flex-sm-row bg-white rounded">
        ...
        <a class="flex-sm-fill text-sm-center nav-link text-dark" href="{{ route('admin.allocation.issued') }}" wire:navigate>
            Tài sản đang cấp phát</a>
        <a class="flex-sm-fill text-sm-center nav-link text-dark" href="{{ route('admin.allocation.history') }}" wire:navigate>
            Lịch sử cấp phát</a>
    </nav>
    <div class="row mt-3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="border-bottom-0 text-center">
                                        ...
                                        <i class="border ti ti-plus rounded p-1 me-1 bg-dark text-white"></i>
                                        @else
