                    ...
                    <div class="row">
                                ...
                                <form wire:submit='searchEquipment'>
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-select" wire:model="equipment_type_id">
                        ...
                        <div class="col-12 mb-3 d-flex justify-content-between">
                            ...
                            <div class="d-flex gap-3">
                                ...
                                <x-button.create :route="'admin.equipment.create'" :name="'Nhập tài sản'"></x-button.create>
                            </div>
                        </div>
                    </div>
                                ...
                                @if (count($equipments) > 0)
                                    @foreach ($equipments as $index => $data)
                                        <tr>
                                            ...
                                            <td class="border-bottom-0">
                                                <x-button.edit :route="'admin.equipment.edit'" :id="$data->id" />
