        ...
        <div class="col-12 d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body p-4">
                    <h5 class="card-title fw-semibold mb-4">Chỉnh sửa loại tài sản</h5>
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="col-5">
                                ...
                                <ul class="list-group equipment-type">
                                    @foreach ($equipment_types as $index => $data)
                                                ...
                                                @else
                                                    @if ($editEquipmentType == false)
                                                        <input class="form-check-input" type="radio"
                                                            value="{{ $data->id }}" wire:model='equipment_type_id'
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-between">
                        <x-button.previous :route="'admin.equipment_type.list'"></x-button.previous>
