                    ...
                    <div class="row">
                            ...
                            <div>
                                <form wire:submit='searchEquipmentCategory'>
                                    ...
                                    <div class="d-flex justify-content-between mb-3">
                                        <div class="col-5">
                                            <x-form.select-option :label="'Kiểu tài sản'" :wire_model="'equipment_type'" :options="$asset_type"
                                                :error="''" />
                                        </div>
                                        <div class="col-5 ">
                                            <div class="mb-3">
                        ...
                        <div class="col-12 mb-3 d-flex justify-content-between">
                            ...
                            <div class="d-flex gap-3">
                                ...
                                <x-button.create :route="'admin.asset_type.create'" :name="'Thêm mới'"></x-button.create>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table text-nowrap mb-0 align-middle table-hover table-bordered">
                            <thead class="text-dark fs-4 bg-secondary-subtle">
                                <tr>
                                    ...
                                    <th class="border-bottom-0">
                                        <h6 class="fw-semibold mb-0">Mã loại tài sản</h6>
                                    </th>
                                    <th class="border-bottom-0">
                            ...
                            <tbody>
                                @if (count($asset_category) > 0)
                                    @foreach ($asset_category as $index => $data)
                                        <tr>
                                            ...
                                            <td class="border-bottom-0">
                                                <h6 class="fw-semibold mb-0">
                                                    {{ $asset_category->firstItem() + $index }}
                                                </h6>
                                            </td>
                                            <td class="border-bottom-0">
                                            ...
                                            <td class="border-bottom-0">
                                                <x-button.edit :route="'admin.asset_type.edit'" :id="$data->id"></x-button.edit>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="flex space-x-4 items-center">
                                <div class="flex items-center">
                                    {{ $asset_category->links('Layout.app.livewire-pagination') }}
                                </div>
                                <span class="float-end">
                                    <h6>
                                        Hiển thị {{ $asset_category->firstItem() }} -
                                        {{ $asset_category->lastItem() }} của
                                        {{ $asset_category->total() }} kết quả
                                    </h6>
                                </span>
                            </div>
                        </div>
